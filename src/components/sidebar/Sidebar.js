  ...
  return (
    <div className="bg-white w-1/5 rounded-t-xl flex-col">
      ...
      <div className='flex flex-col xl:ml-16 sm:ml-4 gap-8  text-gray-500 text-xl '>
        <button className="flex gap-1 hover:text-gray-900" onClick={() => route.push('/')}>
          <HomeIcon />
          Inicio
        </button>
        <button className="flex gap-1 hover:text-gray-900" onClick={() => route.push('/search')}>
          <SearchIcon />
          Pesquisar
        </button>
        <button className="flex gap-1 hover:text-gray-900" href="#">
          <FavIcon />
          Favoritos
        </button>
      </div>
